...
(function(TW) {
    ...
    function init() {
		...
		* 
		* @method setFillColor
		* @param {String} color this parameter represent the color to assign to the fill mode. for example if you want to set it black, you should do `myShape.setFillColor("black");`
		*/
		...
		/**
		* This method allow you to change the draw mode of the current shape. Two modes are avaible "WIRED" and "FILLED".
		*
		* @method setMode
		...
		* @param {String} color this parameter represent the color to apply to the stroke mode. For example to set the stroke color to black you should used `myShape.setStrokeColor("black");`
		*/
