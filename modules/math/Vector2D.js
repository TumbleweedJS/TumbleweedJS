...
(function(TW) {
	...
	/**
	 ...
	 @return {float} returns the dot product between the current Vector2D and vector2.
	 */
	...
	/**
	 ...
	 @return {float} returns the angle between the current Vector2D and vector2 (expressed in degree).
	 */
	...
	/**
	 ...
	 @return {float} returns the cross product between the current Vector2D and vector2
	 */
